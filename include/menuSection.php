<div class="sidebar">
    <div class="logo-container flex">
        <div class="logo-items flex">
           ...
           <div class="society-name"> <span class="name">Go-Bank</span></div>
        </div>
    </div>
    <hr>
    <div class="menus flex">
        <div class="primary-menus">
            <ul>
                ...
                <a href="./retrait.php">
                    <li>
                        <span class="icon-menu"> <i class="bi bi-arrow-left-square"></i> </span>
                        <span class="text">Retrait</span>
                    </li>
                </a>
                <a href="./comptes.php">
                    <li>
                        <span class="icon-menu"><i class="bi bi-journal-text"></i></span>
